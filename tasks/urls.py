...
urlpatterns = [
    ...
    path(
        ...
        name="gardenbedtask_add"
    ),
    path(
        "bedtasks/<int:pk>/edit/",
        GardenBedTaskUpdateView.as_view(),
        name="gardenbedtask_edit"
    ),
    path(
        "bedtasks/<int:pk>/delete/",
    ...
    path(
        ...
        name="materialusage_add"
    ),
    path(
        "materialusages/<int:pk>/edit/",
        MaterialUsageUpdateView.as_view(),
        name="materialusage_edit"
    ),
    path(
        "materialusages/<int:pk>/delete/",
    ...
    path(
        "tasktools/<int:pk>/edit/",
        TaskToolUpdateView.as_view(),
        name="tasktool_edit"
    ),
    path(
        "tasktools/<int:pk>/delete/",
